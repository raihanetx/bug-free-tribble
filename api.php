<?php
// api.php - হ্যান্ডেলস অল ব্যাকএন্ড লজিক ফর ক্যাটাগরি, প্রোডাক্ট, কুপন এবং অর্ডার
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'delete_customer') {
        ...
        $redirect_url = 'admin.php?view=customers';
    }
